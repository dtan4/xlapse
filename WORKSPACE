...
http_archive(
    ...
    sha256 = "3e96360025214faae26b64bc47343560fa2d38ed4c6b39d49a5d87d65fb65d96",
    strip_prefix = "protobuf-3.29.2",
    urls = [
        "https://mirror.bazel.build/github.com/protocolbuffers/protobuf/archive/v3.29.2.tar.gz",
        "https://github.com/protocolbuffers/protobuf/archive/v3.29.2.tar.gz",
    ],
)
