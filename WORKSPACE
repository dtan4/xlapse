...
http_archive(
    ...
    sha256 = "395176af495d8045ba70697c984a38ab6dde6a2d76a5a2870a6ae62bc4be4480",
    strip_prefix = "protobuf-3.29.1",
    urls = [
        "https://mirror.bazel.build/github.com/protocolbuffers/protobuf/archive/v3.29.1.tar.gz",
        "https://github.com/protocolbuffers/protobuf/archive/v3.29.1.tar.gz",
    ],
)
